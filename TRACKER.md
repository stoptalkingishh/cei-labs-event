...
> **❌ Section-wide: not started.** The only "runbook" found anywhere (`CEI-Labs-Wargames/docs/facilitation-runbook.md`) is a classroom facilitation guide, not an event-ops/incident runbook — it does not satisfy this section's P0 item. **Merged 2026-07-22 (event PR #3):** `docs/briefings/CEI-Labs-Wargames-Rehearsal-and-BC-Briefing-Guide.docx` adds a Wargames-specific rehearsal/BC briefing (16 July rehearsal sequence, 23 July BC briefing framework, presenter responsibilities, logistics/DRAW/equipment checks, evaluation) — useful staff-facing input for the P0 runbook item below, but it's a briefing guide for one track, not the cross-repo event runbook itself.
